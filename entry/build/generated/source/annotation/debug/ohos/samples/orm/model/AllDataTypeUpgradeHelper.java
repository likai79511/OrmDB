...
public class AllDataTypeUpgradeHelper implements EntityHelper<AllDataTypeUpgrade> {
    ...
    @Override
    public void bindValue(Statement statement, AllDataTypeUpgrade object, long id) {
        this.bindValue(statement, object);
        statement.setLong(25, id);
    }

    @Override
    public AllDataTypeUpgrade createInstance(ResultSet resultSet) {
        AllDataTypeUpgrade object = new AllDataTypeUpgrade();
    ...
    @Override
    public void setPrimaryKeyValue(AllDataTypeUpgrade object, long value) {
    ...
    public OrmPredicates generatePredicatesGetRelated(String foreignKeyName,
            List<AllDataTypeUpgrade> objects) {
        return null;
    }
}
